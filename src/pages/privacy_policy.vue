<template>
    <div class="q-pa-md">
        ...
        <p>A sua privacidade é importante para nós. É política do Porksmith App respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=www.porksmith.com.br>Porksmith App</a>, e outros sites que possuímos e operamos.</p>
        ...
        <h2>Política de Cookies Porksmith App</h2>
