<template>
    <div>
        <div class="row">
            ...
            <div class="col-5">
                <div v-for="(ingredient,index) in recipeByID($route.params.id).recipe.ingredients"
                :key="index">
                    <q-select
                        class="q-ma-lg"
                        filled
                        v-model="recipeToEdit.ingredients.id"
                        label="Ingrediente"
            ...
            <div class="col-5">
                <div v-for="prepStep in recipeByID($route.params.id).recipe.prep_steps"
                    :key="prepStep.seq">
